...
public class Steps {
	...
	public void i_am_able_to_naviagte_onto_the_login_page() {
		System.setProperty("webdriver.chrome.driver", "C:\\Desktop_Backup\\SeleniumStrechedProject\\AllProjectJars\\chromedriver.exe");
		//System.setProperty("webdriver.chrome.driver", "C:\\Desktop_Backup\\SeleniumStrechedProject\\AllProjectJars\\chromedriver.exe\");
	...
	public void i_should_see_the_username_as(String string) throws InterruptedException {
		String name = driver.findElement(By.id("homepage-course")).getText();
